...
export default {
  ...
  created() {
    console.log(`生命周期钩子之创建时候的钩子！OrderView.vue 组件被创建了呀！`);
  },
  ...
  mounted() {
    console.log(`生命周期钩子之挂载时候的钩子！OrderView.vue 组件被挂载了呀！`);
  },
  ...
  updated() {
    console.log(`生命周期钩子之更新时候的钩子！OrderView.vue 组件被更新了呀！`);
  },
  ...
  deactivated() {
    console.log(`生命周期钩子之重新激活之前组件实例的钩子！OrderView.vue 组件未被激活呀！`);
  },
  ...
  destroyed() {
    console.log(`生命周期钩子之销毁时候的钩子！OrderView.vue 组件被销毁了呀！`);
  },
